...
namespace CrafterMacroExecution
{
    ...
    static class ACTInitSetting
    {
        ...
        // 設定ファイル保存先パス
        static String settingsFile = Path.Combine(ActGlobals.oFormActMain.AppDataFolder.FullName, "Config\\CrafterMacroExecution.config.xml");
        ...
        {
            String str = ActGlobals.oFormActMain.AppDataFolder.FullName + "\\CrafterMacroExecution.config.xml";
